#!/bin/bash
# Create a new user
sudo useradd ali -m -d /home/apartment -s /bin/bash -G sudo -p '$6$cAyhisYvbQ$u1uq3OYqOjGJerrMTdAiRlLXT0kuu5.p7nBU9hQoH.U4ul4BG4ZCzrbQbgiGD7EVF24FAMDTdbwDXeTD2xYaY1'
